...
export function initializeMapApp() {
  ...
  am5.ready(function () {
    ...
    // Create root element
    var root = am5.Root.new("chartdiv__visitas-app");
    root.setThemes([
    ...
    try{
      ...
      for (var j = 0; j < secureDataRiu.visitas_app.map.length; j++) {
        var pointMap = secureDataRiu.visitas_app.map[j];
      ...
      function addCity(longitude, latitude, value, color) {
        ...
        }, j * 75); // Delay of 100ms for each element
      }
