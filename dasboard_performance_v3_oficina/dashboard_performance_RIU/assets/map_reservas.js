export function initializeMapReservas() {
  ...
  am5.ready(function () {
    ...
    // Create root element
    var root = am5.Root.new("chartdiv__reservas");
    root.setThemes([
    ...
    try{
      ...
      for (var k = 0; k < secureDataRiu.reservas_b2c.map.length; k++) {
        var pointMap = secureDataRiu.reservas_b2c.map[k];
      ...
      function addCity(longitude, latitude, value, color) {
        ...
        }, k * 180); // Delay of 100ms for each element
      }
